...
.. _program_listing_file_launch_denso_welding_with_circular_conveyor_belt.launch.py:

Program Listing for File denso_welding_with_circular_conveyor_belt.launch.py
============================================================================

|exhale_lsh| :ref:`Return to documentation for file <file_launch_denso_welding_with_circular_conveyor_belt.launch.py>` (``launch/denso_welding_with_circular_conveyor_belt.launch.py``)
   ...
   def generate_launch_description():
       ...
       return LaunchDescription(
           [
               ...
               welding_with_circular_conveyor_belt,
