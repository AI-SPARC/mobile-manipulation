...
.. _program_listing_file_launch_denso_welding_with_trajectory.launch.py:

Program Listing for File denso_welding_with_trajectory.launch.py
================================================================

|exhale_lsh| :ref:`Return to documentation for file <file_launch_denso_welding_with_trajectory.launch.py>` (``launch/denso_welding_with_trajectory.launch.py``)
...
.. code-block:: py
   ...
   def generate_launch_description():
       ...
       yaml_file = os.path.join(
           ...
           'config',
           'multiple_poses_with_trajectory.yaml'
       )
   
       welding_with_trajectory = Node(
           package="welding_package",
           executable="welding_with_trajectory",
           name="welding_with_trajectory",
           output="screen",
           parameters=[
               moveit_configs.robot_description,
               moveit_configs.robot_description_semantic,
