...
.. _program_listing_file_launch_denso_welding_multiple_objects.launch.py:

Program Listing for File denso_welding_multiple_objects.launch.py
=================================================================

|exhale_lsh| :ref:`Return to documentation for file <file_launch_denso_welding_multiple_objects.launch.py>` (``launch/denso_welding_multiple_objects.launch.py``)
...
.. code-block:: py
   ...
   def generate_launch_description():
       ...
       welding_multiple_objects = Node(
           package="welding_package",
           executable="welding_multiple_objects",
           name="welding_multiple_objects",
           output="screen",
           parameters=[
               moveit_configs.robot_description,
               moveit_configs.robot_description_semantic,
