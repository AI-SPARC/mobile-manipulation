...
.. _program_listing_file_src_welding_multiple_objects.cpp:

Program Listing for File welding_multiple_objects.cpp
=====================================================

|exhale_lsh| :ref:`Return to documentation for file <file_src_welding_multiple_objects.cpp>` (``src/welding_multiple_objects.cpp``)
