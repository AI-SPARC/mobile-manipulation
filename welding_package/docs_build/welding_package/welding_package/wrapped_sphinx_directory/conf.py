...
exec(open("/home/momesso/pibic/src/welding_package/docs_build/welding_package/welding_package/default_sphinx_project/conf.py").read())
...
ensure_global('project', "welding_package")
ensure_global('author', """momesso""")
...
if rosdoc2_settings.get('enable_breathe', is_doxygen_invoked):
    ...
    breathe_projects.update({        "welding_package Doxygen Project": "/home/momesso/pibic/src/welding_package/docs_build/welding_package/output_staging/generated/doxygen/xml"
    })
    if breathe_projects:
...
if rosdoc2_settings.get('enable_exhale', is_doxygen_invoked):
    ...
    exhale_args.update({
        ...
        "containmentFolder": "/home/momesso/pibic/src/welding_package/docs_build/welding_package/welding_package/wrapped_sphinx_directory/generated",
